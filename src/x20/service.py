"""Serve the dashboard and keep each browser's settings separate."""
...
class SessionCapacityError(RuntimeError):
    """The configured session or ticker limit has been reached."""
...
class SessionManager:
    """Store per-browser settings and share market engines by ticker."""
